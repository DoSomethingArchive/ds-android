...
public class ProfileConfig extends AbstractActionBarActivity {
    ...
    protected void onResume() {
        ...
        List<UserCampaign> userCampaignsInProgress = dao.findUserCampaigns(uid, false);
        List<UserCampaign> userCampaignsCompleted = dao.findUserCampaigns(uid, true);
        int numCampaigns = userCampaignsInProgress.size() + userCampaignsCompleted.size();
