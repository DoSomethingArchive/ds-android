...
public class Welcome extends AbstractActivity {
	...
	private static final String NOTIF_ACTIVITY = "data.xtify.activity";
	// Custom key where payload tells us what campaign page to load
	private static final String NOTIF_CAMPAIGN = "data.xtify.campaign";
	
	// Xtify app key generated by app manager - see console.xtify.com/manage-app-keys
	private static final String XTIFY_APP_KEY = "f49b9425-95d5-45ce-95f0-8974a88efc0f";
	// Sender ID is the Google API project #
	// Found here: https://code.google.com/apis/console/b/0/#project:1066768272703:overview
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        // Enabling Xtify location updates (TODO: determine if battery drain is significant)
