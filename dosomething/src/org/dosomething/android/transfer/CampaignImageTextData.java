 ...
 * Layout of the data is Header, Image, then Text body.
 */
public class CampaignImageTextData implements ICampaignSectionData, Serializable {

    private static final long serialVersionUID = 1L;

    public static String TYPE_ID = "ImageText";
    ...
    public CampaignImageTextData(JSONObject json) {
    ...
    public void addToView(Context context, ViewGroup parent) {
        ...
        View v = inflater.inflate(R.layout.hib_row, parent, false);
